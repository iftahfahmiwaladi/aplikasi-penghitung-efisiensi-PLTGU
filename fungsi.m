  ...
  entropi2	= [0.2961	0.2956	0.295	0.2945	0.2934;
    ...
    %mencari h4 dari pr 
     ...
     wturbinuap1 = ma*(h6-h7)/1000
     qcondenser1 = ma*(h7-h8)/1000
     qcondenser2 = ma*(h11-h10)/1000
     effcond = (qcondenser1/qcondenser2)*100
     wpompa = ma*(h9-h8)/1000
     effbrayton1 = wturbingas/qcomb*100
     effrankine1 = wturbinuap1/qmasukhrsg*100
     efftotal1 = (wturbingas+wturbinuap1)/qcomb*100
     effturbinuap = p6/p7/tur*100
     effpompa = p9/p8/pr*100
    set(h.dayakerjacomp,'string',num2str(wcomp));
    set(h.effcomp,'string',num2str(effcomp));
    set(h.dayakerjacomb,'string',num2str(qcomb));
    set(h.effcomb,'string',num2str(effcomb));
    set(h.dayakerjaturbingas,'string',num2str(wturbingas));
    set(h.effturbingas,'string',num2str(effturbingas));
    set(h.qmasukhrsg,'string',num2str(qmasukhrsg));
    set(h.effhrsg,'string',num2str(effhrsg));
    set(h.wturbinuap,'string',num2str(wturbinuap1));
    set(h.qcondenser,'string',num2str(qcondenser1));
    set(h.wpompa,'string',num2str(wpompa));
    set(h.effcondenser,'string',num2str(effcond));
    set(h.effbrayton,'string',num2str(effbrayton1));
    set(h.effrankine,'string',num2str(effrankine1));
    set(h.efftotal,'string',num2str(efftotal1));
    set(h.effturbinuap,'string',num2str(effturbinuap));
    set(h.effpompa,'string',num2str(effpompa));